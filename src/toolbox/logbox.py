...
def createLogger(logger = 'dungeongenerator', loglvl = 'debug', logsize = '2 MB',
                 count = 5, logpath = '/var/log/', logfile = 'dungeongenerator.log'):
    """!
    ...
    @param logger  Name of logger object; default 'dungeongenerator'
    ...
    @param logfile name of the log file; default dungeongenerator.log
    ...
    #defining the logging format (syslog)
